...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($con, "insert into tblstudents(RFIDNumber, StudentID, StudentName, NIC, Address,Gender, Birthday, ContactNumber, EmailAddress, Password,ProfilePicture, ParentName, ParentContactNumber, ParentEmailAddress) value('$RFIDNumber','$StudentID','$StudentName','$NIC','$Address','$Gender','$Birthday','$ContactNumber','$EmailAddress','$Password','$ProfilePicture','$ParentName','$ParentContactNumber','$ParentEmailAddress')");
    if ($query) {
  ...
  <section class="student-reg">
    ...
    <form action="" method="post" name="studentReg" class="student-regF">
      ...
      <fieldset>
        ...
        <input type="file" id="pPic" name="ProfilePicture">
        <br><br><br><br>
      </fieldset>
      <fieldset>
